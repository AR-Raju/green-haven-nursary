...
export default function LoginPage() {
  ...
  const demoCredentials = {
    ...
    vendor: {
      email: "vendor@greenhaven.com",
      password: "vendor123",
    },
  };

  const fillDemoCredentials = (role: "user" | "admin" | "vendor") => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const userRole = loginForm.email.includes("admin")
        ? "admin"
        : loginForm.email.includes("vendor")
        ? "vendor"
        : "user";
